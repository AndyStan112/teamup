...
import { Card, CardContent, CardMedia, Typography, Stack, Grid2 as Grid, Avatar, CardActionArea, CircularProgress, Container, Chip } from '@mui/material';
              ...
              <CardContent>
                ...
                <Stack direction="row" spacing={1} mt="5px">
                  {project.technologies.map((tech, index) => (
                    <Chip key={index} label={tech} color="primary" variant="filled"   />
                  ))}
                </Stack>
